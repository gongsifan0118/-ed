...
const mockAlerts: AlertGroup[] = [
  {
    ...
    topics: [
      ...
      { id: 102, name: "#伯牙绝弦杯底异物事件#", platform: "小红书", date: "2026-01-02 10:45", reads: "1.5w", discuss: "450", likes: "2.1k", type: "敏感#投诉预警" },
      { id: 103, name: "#霸王茶姬包装被指抄袭大牌#", platform: "抖音", date: "2026-01-02 09:30", reads: "8.8w", discuss: "5.6k", likes: "12w", type: "负面#设计争议" },
      { id: 104, name: "#排队2小时只为一杯霸王茶姬#", platform: "朋友圈", date: "2026-01-02 08:00", reads: "5k", discuss: "89", likes: "231", type: "中性#流量监测" }
    ]
  },
  {
    id: 2,
    ...
    topicCount: 3,
    topics: [
      { id: 201, name: "#二线城市霸王茶姬闭店潮#", platform: "今日头条", date: "2026-01-02 11:20", reads: "2.1w", discuss: "340", likes: "1.2k", type: "负面#经营风险" },
      { id: 202, name: "#霸王茶姬加盟政策变动争议#", platform: "知乎", date: "2026-01-02 10:15", reads: "8k", discuss: "120", likes: "400", type: "敏感#政策预警" },
      { id: 203, name: "#加盟商控诉霸王茶姬割韭菜#", platform: "微博", date: "2026-01-02 09:00", reads: "3.4w", discuss: "980", likes: "5.5k", type: "负面#投诉预警" }
    ]
  },
  {
    id: 3,
    ...
    topicCount: 2,
    topics: [
      { id: 301, name: "#霸王茶姬茶百道世纪联名#", platform: "微博", date: "2026-01-02 14:00", reads: "25w", discuss: "12w", likes: "45w", type: "正面#品牌营销" },
      { id: 302, name: "#联名杯垫被黄牛炒至百元#", platform: "闲鱼", date: "2026-01-02 15:30", reads: "1.2w", discuss: "890", likes: "3.2k", type: "敏感#溢价监控" }
    ]
  }
];
  ...
  const filteredAlerts = useMemo(() => {
    return mockAlerts.map(alert => {
      ...
      const filteredTopics = alert.topics.filter(t => 
        t.name.toLowerCase().includes(filterTopic.toLowerCase())
      );

      // Show alert if its name or item matches, OR if any of its topics match
      if (alertMatch || itemMatch || (filterTopic && filteredTopics.length > 0)) {
        return { ...alert, topics: filteredTopics };
      }
      return null;
    }).filter(Boolean) as AlertGroup[];
  }, [filterAlert, filterItem, filterTopic]);
      ...
      <div className="relative w-[1100px] h-full bg-white flex flex-col shadow-2xl animate-in slide-in-from-right duration-300">
        ...
        <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
          <h2 className="text-base font-bold text-slate-800 flex items-center">
            ...
            话题清单 - <span className="ml-2 text-blue-600 font-bold">霸王茶姬 专项监测</span>
          </h2>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 bg-slate-50/50 border-b border-slate-100">
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="space-y-1.5">
              ...
              <select className="w-full text-xs border-slate-200 rounded focus:ring-1 focus:ring-blue-600 outline-none py-2 px-3 bg-white">
                <option>全部等级</option>
                <option>高风险</option>
                <option>中风险</option>
              </select>
            </div>
            <div className="col-span-4 flex items-end justify-end space-x-3">
              <button 
                onClick={() => { setFilterAlert(''); setFilterItem(''); setFilterTopic(''); }}
                              ...
                              <div className="flex flex-col space-y-3">
                                ...
                                <div className="flex items-center text-xs text-slate-400 space-x-4">
                                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest ${
                                    topic.type.includes('负面') ? 'bg-red-50 text-red-500 border border-red-100' : 'bg-yellow-50 text-yellow-600 border border-yellow-100'
                                  }`}>
                                    {topic.type}
                                  </span>
